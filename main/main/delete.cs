                ...
                if (ob1.IsMatch(arg[2]))
                {
                    ...
                    if (type == "column")
                    {
                        ...
                        for (int i = 1; i < lastCell.Column; i++)
                        {
                            ...
                            if (ObjWorkSheet.Cells[1, i].Text.ToString() == NameColumn + ".txt" || ObjWorkSheet.Cells[1, i].Text.ToString() == NameColumn + ".int" || ObjWorkSheet.Cells[1, i].Text.ToString() == NameColumn + ".date")
                            {
                                ...
                                for (int j = 2; j <= lastCell.Row; j++)
                                {
                                    ...
                                    {
                                        ObjWorkSheet.Rows[j].Delete(); break;
                                    }
